module github.com/Falokut/admin_casts_service

go 1.21.5

require (
	github.com/Falokut/admin_movies_persons_service v0.0.0-20240127075214-8827c83cb425
	github.com/Falokut/admin_movies_service v0.0.0-20240130074022-1609e6e6e6a7
