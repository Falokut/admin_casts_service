...
require (
	github.com/Falokut/admin_movies_persons_service v0.0.0-20240203081128-8a629eacc5c4
	github.com/Falokut/admin_movies_service v0.0.0-20240227202856-e075ff3978a2
